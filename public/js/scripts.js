            ...
            nyasa.window.on("load", function() {
                ...
                $.jasmineNoty = function(a) {
                    var j, b = {
                        ...
                        l = function(a) {
                            return "floating" === c.container && c.floating.animationOut && (d.removeClass(c.floating.animationIn).addClass(c.floating.animationOut), nyasa.transition || d.remove()), d.removeClass("in").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(a) {
                    ...
                    (function() {
                        if ("page" === c.container) e || (e = $('<div id="page-alert"></div>'), nyasa.contentContainer.prepend(e)), g = e, c.focus && m(0);
                        else if ("floating" === c.container) f[c.floating.position] || (f[c.floating.position] = $('<div id="floating-' + c.floating.position + '" class="floating-container"></div>'), nyasa.container.append(f[c.floating.position])), g = f[c.floating.position], c.floating.animationIn && d.addClass("in animated " + c.floating.animationIn), c.focus = !1;
                        else {
                            var a = $(c.container),
